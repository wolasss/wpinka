...
Package.on_use(function (api) {
    ...
    api.use(['app', 'tap:i18n', 'iron:router', 'templating', 'reactive-var', 'app-stream', 'app-position-stream', 'app-fixed-stream', 'underscore'], both);
    ...
    api.add_files('client/views/market.html', 'client');
    api.add_files('client/views/market.js', 'client');
    ...
    api.add_files('client/views/events/market.js', 'client');
    api.add_files('client/views/subscriptions/market.js', 'client');
