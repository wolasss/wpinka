...
Package.on_use(function (api) {
    ...
    api.use(['templating', 'meteoric:autoform-ionic', 'aldeed:autoform', 'underscore', 'reactive-var', 'aldeed:simple-schema'], 'client')
    ...
    api.add_files('client/views/nodes.html', 'client');
    api.add_files('client/views/nodes.js', 'client');
    api.add_files('client/views/events/nodes.js', 'client');
